...
import asyncio
import psutil
from src.opentrusteval.pipelines.high_performance_system.legacy_compatibility import init_db, log_pipeline

# Import LLM manager router
try:
    from src.opentrusteval.api.cloudscale_apis.endpoints.llm_manager import router as llm_router
...
try:
    from src.opentrusteval.api.cloudscale_apis.endpoints.data_manager import router as data_router
...
try:
    from src.opentrusteval.api.cloudscale_apis.endpoints.security_manager import router as security_router
...
try:
    from src.opentrusteval.api.cloudscale_apis.endpoints.research_platform import router as research_router
...
async def evaluate(
    ...
    discovered_plugins = load_plugins('src/opentrusteval/plugins')
    img = None
    try:
